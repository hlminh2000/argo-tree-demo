...
class Link extends Component {
  render() {
    ...
    const midPoint = svgPath.getPointAtLength(
      Math.ceil(svgPath.getTotalLength() / 2)
    );
    svgPath.remove();
    ...
    alpha = isNaN(alpha)
      ? 0
      : (alpha + 1) * (movePoint[0] > lastPoint[0] ? 90 : -90);
    const transform = new Transform()
      .translate(movePoint[0], movePoint[1])
      .rotate(alpha);
    return (
      <Group key={pathId}>
